  ...
  public class TabIndexing
    {
        ...
        public TabIndexing(Control container)
        {
        ...
        private TabIndexing(Control container, int curTabIndex, Hashtable schemeOverrides)
        {
            this.container = container;
            ...
            try
            {
                ...
                foreach (Control c in controlArraySorted)
                {
                    ...
                    if (c.Controls.Count > 0)
                    {
                        ...
                        curTabIndex = (new TabIndexing(c, curTabIndex, schemeOverrides)).SetTabOrder(childScheme);
                    }
                }
